...
public class Test {
    ...
    /*
     * Considerare il programma di cui sotto, già funzionante e si provi ad usarlo.
     * È realizzato con classe GUI e interfaccia/implementazione per la logica.
     * Scopo dell'esercizio è rifattorizzare il la logica progetto (non la GUI)
     * migliorandone la qualità, e ottenendo un buon testing delle sue varie parti.
     *
     * Si propone il seguente approccio TDD.
     * 
     * Primo passo, sigilliamo LogicsImpl:
     * 1) si scrivano alcuni test che passano su Logics/LogicsImpl,
     *  e che ci sembrano catturare il grosso del funzionamento della logica
     ...
     * 2) si costruisca l'interfaccia e la sua implementazione con TDD,
     *  ossia con vari step di red-green-refactor sulla nuova classe
     ...
     * 2) si crei un diagramma UML del sistema prodotto
     * 
